...
export default function LoginPage() {
  ...
  useEffect(() => {
    const savedTheme = localStorage.getItem("awm-auth-theme") as ThemeMode | null;
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      if (result.token) {
        localStorage.setItem("awm-auth-token", result.token);
      }
          ...
          <div className="p-6 sm:p-8">
            ...
            {step === "credentials" && (
              <div className="space-y-5">
                ...
                {/* REGISTER LINK */}
                <div className={`mt-4 text-center text-sm ${ui.muted}`}>
            ...
            {step === "otp" && (
              <div className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full text-center text-sm font-medium ${ui.muted} transition-all hover:text-cyan-400`}
                >
                  ← Back to login
                </button>
              </div>
