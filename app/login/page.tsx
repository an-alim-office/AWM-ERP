        ...
        <div className="relative z-10 flex w-full flex-col justify-between p-10 xl:p-14">
          <div>
           ...
           <div className="mt-10 text-center">
              ...
              <p
                className={`mt-6 text-base leading-8 ${ui.muted}`}
              >
                AI-powered device recognition, OTP
                verification, session intelligence
                and enterprise-grade threat
                detection system for advanced
                workforce security.
              </p>
            </div>
          ...
          <div
            className={`rounded-[32px] border p-6 ${ui.card} ${ui.border}`}
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3
                  className={`mt-3 text-5xl font-black ${ui.text}`}
                >
                  {securityScore}%
                </h3>
              </div>
      ...
      <section className="relative z-10 flex w-full items-center justify-center p-4 sm:p-6 lg:max-w-[760px] lg:p-10">
        ...
        >
          ...
          >
            <div>
              <h2
                className={`text-3xl font-black tracking-tight ${ui.text}`}
              >
                {step === "credentials" &&
                  "Secure Login"}
          ...
          <div className="p-6 sm:p-8">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4
                        className={`mt-3 font-bold ${ui.secondary}`}
                      >
                        {item.value}
                      </h4>
                    </div>
            ...
            {step === "credentials" && (
              <div className="space-y-5">
                ...
                {/* TRUSTED DEVICE */}
                <div
                  className={`rounded-2xl border p-5 ${ui.surface} ${ui.border}`}
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p
                        className={`mt-1 text-sm leading-6 ${ui.muted}`}
                      >
                        Reduce future
                ...
                <div className="flex flex-col gap-4 pt-1 sm:flex-row sm:items-center sm:justify-between">
                  <label className="flex cursor-pointer items-center gap-3">
                    ...
                    <span
                      className={`text-sm font-medium ${ui.secondary}`}
                    >
                      Persistent secure
                      session
                    </span>
            ...
            {step === "success" && (
              <div className="py-10 text-center">
                ...
                <h3
                  className={`mt-6 text-3xl font-black ${ui.text}`}
                >
                  Authentication
                  Successful
                </h3>
            ...
            {/* FOOTER */}
            <div
              className={`mt-8 border-t pt-6 text-center ${ui.border}`}
            >
              <p
                className={`text-xs leading-6 ${ui.muted}`}
              >
